            ...
            <div style={{
              ...
              {SERVICES_LIST.map((s) => (
                <Link key={s.slug} href={`/services/${s.slug}`} style={{
                  ...
                  padding: "10px 20px", color: s.slug === "data-ai-services" ? "#fff" : "#a0a0a0", textDecoration: "none",
                  transition: "all 0.15s",
                }}
                  onMouseEnter={e => { e.currentTarget.style.background = "#1a1a1a"; e.currentTarget.style.color = "#fff"; }}
                  onMouseLeave={e => { e.currentTarget.style.background = "transparent"; e.currentTarget.style.color = s.slug === "data-ai-services" ? "#fff" : "#a0a0a0"; }}>
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 64, alignItems: "center" }}>
          <div>
            ...
            <p style={{ fontSize: 15, color: "#6366f1", fontWeight: 500, marginBottom: 16, lineHeight: 1.6 }}>
              End-to-end data solutions and AI-powered systems that drive smarter decisions.
            </p>
      ...
      <section style={{ padding: "60px 5%", background: "#080808" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto", textAlign: "center" }}>
          ...
          <div style={{ display: "flex", gap: 40, justifyContent: "center", flexWrap: "wrap", alignItems: "center" }}>
            ...
            {["Python", "TensorFlow", "PyTorch", "Apache Spark"].map((tech) => (
