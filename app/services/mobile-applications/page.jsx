            ...
            <div style={{
              ...
              {SERVICES_LIST.map((s) => (
                <Link key={s.slug} href={`/services/${s.slug}`} style={{
                  ...
                  padding: "10px 20px", color: s.slug === "mobile-applications" ? "#fff" : "#a0a0a0", textDecoration: "none",
                  transition: "all 0.15s",
                }}
                  onMouseEnter={e => { e.currentTarget.style.background = "#1a1a1a"; e.currentTarget.style.color = "#fff"; }}
                  onMouseLeave={e => { e.currentTarget.style.background = "transparent"; e.currentTarget.style.color = s.slug === "mobile-applications" ? "#fff" : "#a0a0a0"; }}>
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 64, alignItems: "center" }}>
          <div>
            ...
            <p style={{ fontSize: 15, color: "#6366f1", fontWeight: 500, marginBottom: 16, lineHeight: 1.6 }}>
              Native and cross-platform apps built for performance and a polished user experience.
            </p>
